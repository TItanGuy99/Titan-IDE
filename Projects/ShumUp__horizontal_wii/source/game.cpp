...
game::game() //constructor
{
	...
	titan_logo = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/menu/Titan.bmp", 1, 1, 1);
	press_start = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/menu/Start_Game.bmp", 0x00, 0x00, 0x00);
	m_screen = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/menu/menu.bmp", 1, 1, 1);
	game_over = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/menu/game_over.bmp", 1, 1, 1);
	final_screen = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/menu/final_screen.bmp", 1, 1, 1);
	blocksBG = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/BG/blocks.bmp", 0xff, 0x00, 0x00);
	bul = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/bullets/BLT.bmp", 0x00, 0x00, 0x00);
	ite = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/itens/rings.bmp", 0xff, 0x00, 0xff);
	ene = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/enemy/enemy.bmp", 0xff, 0x00, 0xff);
	ene2 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/enemy/enemy2.bmp", 0xff, 0x00, 0xff);
	hud = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/hud/HUD.bmp", 0xff, 0x00, 0xff);
	numb = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N3.bmp", 0x00, 0x00, 0x00);
	n9 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N9.bmp", 0x00, 0x00, 0x00);
	n8 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N8.bmp", 0x00, 0x00, 0x00);
	n7 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N7.bmp", 0x00, 0x00, 0x00);
	n6 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N6.bmp", 0x00, 0x00, 0x00);
	n5 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N5.bmp", 0x00, 0x00, 0x00);
	n4 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N4.bmp", 0x00, 0x00, 0x00);
	n3 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N3.bmp", 0x00, 0x00, 0x00);
	n2 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N2.bmp", 0x00, 0x00, 0x00);
	n1 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N1.bmp", 0x00, 0x00, 0x00);
	n0 = load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/numbers/N0.bmp", 0x00, 0x00, 0x00);
	is_shoting = false;
	control_bullet = 0;
	power_up = 0;
	score = 0;
	...
	running = true;
	all_running = true;
	player1 = new player(load_image("sd:/apps/Titan_ShumUpHorizontal/rd/images/player/player.bmp", 0xff, 0x00, 0xff));
	finish.x = 0;
	finish.y = 0;
	finish.w = 50;
	finish.h = 50;
